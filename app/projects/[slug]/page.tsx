  ...
  return (
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-3xl mx-auto">
        ...
        {isAdmin && (
          <Link href={`/admin/dashboard?edit=project&id=${project.id}`}>
            <Button className="mb-6 ml-2">Edit Project</Button>
          </Link>
        )}
        ...
        <article>
          ...
          <p className="text-muted-foreground mb-8">{new Date(project.created_at).toLocaleDateString()}</p>
